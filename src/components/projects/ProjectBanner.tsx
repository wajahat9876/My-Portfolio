...
/**
 * Web project screenshot in browser chrome on a tinted backdrop.
 * App projects use PhoneColumn on the card instead — a portrait shot in a
 * wide banner always left dead space either side.
 */
